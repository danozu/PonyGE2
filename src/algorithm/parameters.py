...
params = {
        ...
        'DATASET_TRAIN': "multiplexer/Train.csv",
        'DATASET_TEST': "multiplexer/Test.csv",
        'DATASET_DELIMITER': None,

        # Set grammar file
        'GRAMMAR_FILE': "supervised_learning/multiplexer_11bitA.bnf",
...
def set_params(command_line_args, create_files=True):
    ...
    if params['LOAD_STATE']:
        ...
        if params['SELECTION'].split(".")[-1] == "lexicase":
